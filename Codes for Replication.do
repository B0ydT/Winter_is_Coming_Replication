...
use "C:\Users\Steven Guo\Nutstore\1\Famine\EJ\4th\Replication package\Data for Replication.dta", clear
cd "C:\Users\Steven Guo\Nutstore\1\Famine\EJ\4th\Replication package\Results"
...
outreg2 using table_2, tex replace dec(2) sortvar(c.famineseverity#c.born4960 c.famineseverity#c.born4954 c.famineseverity#c.born5560) addstat(Number of work counties, `e(N_clust)', Adjusted R-squared, `e(r2_a)', Within R-squared, `e(r2_within)')
...
outreg2 using table_2, tex append dec(2) sortvar(c.famineseverity#c.born4960 c.famineseverity#c.born4954 c.famineseverity#c.born5560) addstat(Number of work counties, `e(N_clust)', Adjusted R-squared, `e(r2_a)', Within R-squared, `e(r2_within)')
