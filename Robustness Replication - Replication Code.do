...
outreg2 using table_2rep, tex replace dec(2) stats(coef pval) sortvar(c.famineseverity#c.born4960 c.famineseverity#c.born4954 c.famineseverity#c.born5560) addstat(Number of work counties, `e(N_clust)', Adjusted R-squared, `e(r2_a)', Within R-squared, `e(r2_within)')
...
outreg2 using table_2rep, tex append dec(2) stats(coef pval) sortvar(c.famineseverity#c.born4960 c.famineseverity#c.born4954 c.famineseverity#c.born5560) addstat(Number of work counties, `e(N_clust)', Adjusted R-squared, `e(r2_a)', Within R-squared, `e(r2_within)')
...
outreg2 using table_2sample, tex replace dec(2) stats(coef pval) keep(c.famineseverity#c.born4960 c.famineseverity#c.born4954 c.famineseverity#c.born5560) addstat(Number of work counties, `e(N_clust)', Adjusted R-squared, `e(r2_a)', Within R-squared, `e(r2_within)')
...
outreg2 using table_2sample, tex append dec(2) stats(coef pval) keep(c.famineseverity#c.born4960 c.famineseverity#c.born4954 c.famineseverity#c.born5560) addstat(Number of work counties, `e(N_clust)', Adjusted R-squared, `e(r2_a)', Within R-squared, `e(r2_within)')
